...
console.log('task 1b:', createMenuItem('pancakes', 12, 'brakefast'));
console.log('task 1b:', createMenuItem('chocolate lava cake', 4, 'dessert'));
...
let newArray = []
addReview(newArray, 'Billy', 2, 'Lame food!')
addReview(newArray, 'Braian', 5, 'Awsome food!')
addReview(newArray, 'Amanda', 3.5, 'Meh food!')
